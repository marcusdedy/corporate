...
?>
    ...
    <h6><font color="orange" size="5"><u>Data PO</u></font>       <u>
    <left></left>
    </u></h6>
<form action="home-warehouse.php?page=form-view-data-po" method="post" name="postform">
...
<table width="1206" border="0" align="center" cellpadding="0" cellspacing="1">
	<tr bgcolor="#0066FF">
        ...
        <th width="10%"><font color="#FFFFFF">Total Product</font>
      	<th width="10%"><font color="#FFFFFF">Total Qty</font>
      	<th width="10%"><font color="#FFFFFF">Total Price</font>     
      	<th width="17%"><font color="#FFFFFF">Action</font></td>&nbsp; 
	</tr>
    ...
    while (	$hasil = mysql_fetch_array ($Tampil)) {
            ...
            $product        = stripslashes ($hasil['product']);
    ...
    <tr align="center">
        ...
        <td align="center" bgcolor="#EEF2F7"><?=$product?></td>
        ...
        <a href=files\po\<?=$file_name_detail?>  target="_blank" > Print PO </a>
         || 
         <a href="javascript:void(0);"
            onclick="window.open('form-input-faktur-jual.php?po_number=<?php echo $po_number; ?>','nama_window_pop_up','height = 450, width = 680, top = 70, left = 120, resizable = 0')"> Input Faktur </a>
        </div></td>
    </tr>
    <tr>
