...
?>
    ...
    <h6><font color="orange" size="5"><u>Upload File PO</u></font>       <u>
    <left></left>
    </u></h6>
<form action="home-buyer.php?page=form-view-upload-file-po" method="post" name="postform">
...
<table width="1206" border="0" align="center" cellpadding="0" cellspacing="1">
    ...
    onclick="window.open('form-upload-file-po.php?po_number=<?php echo $po_number; ?>','nama_window_pop_up','height = 350, width = 480, top = 50, left = 90, resizable = 0')">Upload File</div></td>
    </tr>
    <tr>
